...
export function FlowExecutionProgress({ onComplete }: FlowExecutionProgressProps) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-[#17173A] dark:text-white leading-normal font-['Nunito Sans'] mb-4">
      ...
      <div className="space-y-6">
        {campaigns.map((campaign, campaignIndex) => (
          <div key={campaign.id} className="space-y-3">
            ...
            <div className="text-sm font-medium text-[#17173A] dark:text-white leading-normal font-['Nunito Sans']">
              ...
              {campaign.steps.map((step, stepIndex) => (
                <div key={step.id} className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className={cn(
                      "text-sm leading-normal font-['Nunito Sans']",
