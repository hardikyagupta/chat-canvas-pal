    ...
    <div className="w-full">
      ...
      <div className="flex w-full items-start gap-10 rounded-2xl bg-white p-10">
        ...
        <div className="flex min-w-0 flex-1 flex-col pt-2">
          ...
          <h2 className="mt-3 max-w-[560px] font-manrope text-[28px] font-bold leading-[1.2] text-[#17173A]">
            Achieve every objective through customer-level decisions. Let the engine decide who gets what, when, and where.
          </h2>
